...
public class GameController {
	...
	private ExecutorService updaters = Executors.newFixedThreadPool(4); // 4 threads for the max 4 players
	...
	public void setGameBoard(@PathVariable(name = "gameid") Long gameid, @RequestBody String gameBoard) {
	...
	/**
	 * Updates the last action of the specified game, flags for game update to be
	 * sent
	 * 
	 * @param gameid
	 * @param action
