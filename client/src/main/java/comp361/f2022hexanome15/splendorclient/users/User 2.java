package comp361.f2022hexanome15.splendorclient.users;

import static comp361.f2022hexanome15.splendorclient.lobbyserviceio.LobbyServiceExecutor.LOBBY_SERVICE_EXECUTOR;
...
public class User {
	...
	public String toString() {
		return "User [userName=" + userName + ", accessToken=" + accessToken + ", refreshToken=" + refreshToken
